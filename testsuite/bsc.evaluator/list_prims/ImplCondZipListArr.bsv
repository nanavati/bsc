...
// Reference: list->array->zipWith->list via primListToArray/primArrayZipWith/primArrayToList.
// Must produce identical sorted output to sysImplCondZipList.out.expected.
// Also exercises primListToArray/primArrayToList condition propagation.

(* synthesize *)
module sysImplCondZipListArr(Empty);
  ...
  List#(Bit#(8)) zipped = primArrayToList(primArrayZipWith(\+ , primListToArray(avals), primListToArray(bvals)));
