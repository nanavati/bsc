...
header = B.unpack $ TE.encodeUtf8 $ T.pack "bsc-ba-20260727-1"
...
genABinFile errh remapP fn abin =
    writeBinaryFileLazyCatch errh fn
        (BL.fromStrict headerBS `BL.append` encodeLazyWith remapP abin)
      ...
      where
        ...
        wr_chunk9 =
          do
             ...
             toBin a_139; toBin a_140; toBin a_141; toBin a_142
    readBytes =
       do
          ...
          (a_135, a_136, a_137, a_138, a_139, a_140, a_141, a_142) <- rd_chunk9
          return (Flags
                a_000 a_001 a_002 a_003 a_004 a_005 a_006 a_007 a_008 a_009
                a_010 a_011 a_012 a_013 a_014 a_015 a_016 a_017 a_018 a_019
                a_020 a_021 a_022 a_023 a_024 a_025 a_026 a_027 a_028 a_029
      ...
      where
        ...
        rd_chunk9 =
          do
             ...
             a_138 <- fromBin; a_139 <- fromBin; a_140 <- fromBin;
             a_141 <- fromBin; a_142 <- fromBin
             return (a_135, a_136, a_137, a_138, a_139, a_140, a_141, a_142)
