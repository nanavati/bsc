...
NOTE 2026-07-10: the live branch is claude/bluesim3-fst — the whole
history REBASED onto personal/bluesim-fst (PR #1027, FST support)
plus the bsim3 FST implementation.  claude/bluesim3 fast-forwards
...
- Local ladders: tests/regress/run.sh (6), tests/vcd/run.sh (10),
  tests/interactive/run.sh (33; needs BSIM3_CAPI_LIB=<libbsim3_capi.a>),
...
1. FST REBASE (task #7, IN FLIGHT 2026-07-10): claude/bluesim3-fst
   = all 264 commits rebased onto personal/bluesim-fst + the bsim3
   ...
   timestamps).  Reference-vs-bsim3 FST: SEMANTIC MATCH (batch +
