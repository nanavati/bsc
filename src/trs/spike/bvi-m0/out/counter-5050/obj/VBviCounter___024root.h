...
class alignas(VL_CACHE_LINE_BYTES) VBviCounter___024root final {
  public:
    ...
    CData/*0:0*/ __Vtrigprevexpr___TOP__EN_bump__0;
    CData/*7:0*/ __Vtrigprevexpr___TOP__bump_amt__0;
    ...
    // INTERNAL VARIABLES
    VBviCounter__Syms* vlSymsp;
    const char* vlNamep;

    // CONSTRUCTORS
    VBviCounter___024root(VBviCounter__Syms* symsp, const char* namep);
