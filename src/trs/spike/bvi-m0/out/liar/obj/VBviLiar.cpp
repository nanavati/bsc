...
VL_ATTR_COLD void VBviLiar::trace(VerilatedVcdC* tfp, int levels, int options) {
    vl_fatal(__FILE__, __LINE__, __FILE__,"'VBviLiar::trace()' called on model that was Verilated without --trace option");
}
