...
void VBviViolator___024root___eval_act(VBviViolator___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VBviViolator__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VBviViolator___024root___eval_act\n"); );
}

VL_INLINE_OPT void VBviViolator___024root___nba_sequent__TOP__0(VBviViolator___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VBviViolator__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VBviViolator___024root___nba_sequent__TOP__0\n"); );
    // Body
    vlSelf->BviViolator__DOT__cnt = (0xffU & ((IData)(1U) 
                                              + (IData)(vlSelf->BviViolator__DOT__cnt)));
    vlSelf->COUNT = vlSelf->BviViolator__DOT__cnt;
}

void VBviViolator___024root___eval_nba(VBviViolator___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VBviViolator__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VBviViolator___024root___eval_nba\n"); );
    // Body
    if ((1ULL & vlSelf->__VnbaTriggered.word(0U))) {
        VBviViolator___024root___nba_sequent__TOP__0(vlSelf);
    }
}
...
bool VBviViolator___024root___eval_phase__act(VBviViolator___024root* vlSelf) {
    ...
    // Body
    VBviViolator___024root___eval_triggers__act(vlSelf);
    __VactExecute = vlSelf->__VactTriggered.any();
    if (__VactExecute) {
        __VpreTriggered.andNot(vlSelf->__VactTriggered, vlSelf->__VnbaTriggered);
        vlSelf->__VnbaTriggered.thisOr(vlSelf->__VactTriggered);
        VBviViolator___024root___eval_act(vlSelf);
    }
...
bool VBviViolator___024root___eval_phase__nba(VBviViolator___024root* vlSelf) {
    ...
    if (__VnbaExecute) {
        VBviViolator___024root___eval_nba(vlSelf);
...
#ifdef VL_DEBUG
            VBviViolator___024root___dump_triggers__nba(vlSelf);
#endif
            VL_FATAL_MT("/home/user/bsc-matx/src/trs/spike/bvi-m0/rtl/BviViolator.v", 5, "", "NBA region did not converge.");
        }
...
#endif
                VL_FATAL_MT("/home/user/bsc-matx/src/trs/spike/bvi-m0/rtl/BviViolator.v", 5, "", "Active region did not converge.");
            }
            vlSelf->__VactIterCount = ((IData)(1U) 
                                       + vlSelf->__VactIterCount);
            vlSelf->__VactContinue = 0U;
            if (VBviViolator___024root___eval_phase__act(vlSelf)) {
                vlSelf->__VactContinue = 1U;
            }
        }
        if (VBviViolator___024root___eval_phase__nba(vlSelf)) {
            __VnbaContinue = 1U;
        }
    }
}
