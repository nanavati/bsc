...
#    make -f VBviParams.mk

default: libVBviParams
...
VM_PREFIX = VBviParams
# Module prefix (from --prefix)
VM_MODPREFIX = VBviParams
...
include VBviParams_classes.mk
# Include global rules
include $(VERILATOR_ROOT)/include/verilated.mk

### Library rules (default lib mode)
libVBviParams.a: $(VK_OBJS) $(VK_USER_OBJS) $(VM_HIER_LIBS)
libverilated.a: $(VK_GLOBAL_OBJS)
libVBviParams: libVBviParams.a libverilated.a $(VM_PREFIX)__ALL.a
# Verilated -*- Makefile -*-
